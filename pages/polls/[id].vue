        ...
        <ol>
            <li v-for="(question, index) in poll.expand!.questions" :key="index">
                <div>
                    ...
                    <div v-for="(option, optionIndex) in question.expand.options" :key="optionIndex">
                        <input type="radio" :id="option.id" :name="question.identifier" :value="option.id" class="mr-3"
